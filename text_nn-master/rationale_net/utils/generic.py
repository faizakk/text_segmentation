...
def tensor_to_numpy(tensor):
	print('This is the tensor you are looking for',tensor)
	print('tensor.item()',tensor.item())
	#print('tensor.data[0]',tensor.data[0])
...
def parse_args():
    ...
    parser.add_argument('--epochs', type=int, default=205, help='number of epochs for train [default: 256]')
    ...
    parser.add_argument('--results_path', type=str, default='output1', help='where to dump model config and epoch stats. If get_rationales is set to true, rationales for the test set will also be stored here.')
    ...
    # data
    parser.add_argument('--dataset', default='autoscribe', help='choose which dataset to run on. [default: news_group]')
